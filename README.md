...
Connected-extrusion regressions cover one and two touching walls, twenty wall sections, rotated meshes, repeated joins, exact roof heights, and real obstacles. The browser suite pulls these faces with actual pointer gestures, checks exported volume and closed topology, and compares exact undo results.
